...
The prompts are there to help jump-start your ideation process. If you would like to change or combine prompts, that's fine! If you want to find your own idea, even better. **Consult your instructors/IAs for final approval before getting started.**  
...
4) A respository hosted on one group member's **_personal GitHub_** (NOT GHE) containing the project materials detailed above. 
